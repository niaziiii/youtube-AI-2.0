    ...
    <div className="w-full">
      ...
      >
        <div className="w-[90%] sm:w-[80%] md:w-[60%] m-auto mt-10 md:mt-16 mb-14">
          ...
          <p>
            Last updated: February 18, 2024 <br /> <br /> This Privacy Policy
          ...
          <p>
            ...
            <br /> <br /> Definitions ~~~~~~~~~~~ <br /> <br /> For the purposes
            of this Privacy Policy:
            <br /> <br /> * Account means a unique account created for You to
            ...
            uses. <br /> <br />* Country refers to: Pakistan <br /> <br />*
            Device means any device that can access the Service such as a
            computer, a cellphone or a digital tablet. <br /> <br />* Personal
            Data is any information that relates to an identified or
            identifiable individual. <br /> <br />* Service refers to the
            Website.
            <br /> <br /> * Service Provider means any natural or legal person
            who processes the data on behalf of the Company. It refers to
            third-party companies or individuals employed by the Company to
            facilitate the Service, to provide the Service on behalf of the
            Company, to perform services related to the Service or to assist the
            Company in analyzing how the Service is used.
            <br /> <br /> * Usage Data refers to data collected automatically,
            either generated by the use of the Service or from the Service
            infrastructure itself (for example, the duration of a page visit).
            <br /> <br /> * Website refers to Writroai, accessible from{" "}
            {" <https://writroai.com>"}
            <br /> <br />* You means the individual accessing or using the
            Service, or the company, or other legal entity on behalf of which
            such individual is accessing or using the Service, as applicable.
            <br /> <br /> Collecting and Using Your Personal Data
            ---------------------------------------
            <br /> <br /> Types of Data Collected ~~~~~~~~~~~~~~~~~~~~~~~ <br />{" "}
            <br />
            Personal Data ************* <br /> <br />
            ...
            by or through a mobile device. <br /> <br />
            ...
            <br /> <br /> * Web Beacons. Certain sections of our Service and our
            ...
            Cookies for the purposes set out below: <br /> <br />* Necessary /
            Essential Cookies <br /> <br /> Type: Session Cookies <br /> <br />
            ...
            provide You with those services. <br /> <br />* Cookies Policy /
            Notice Acceptance Cookies <br /> <br />
            ...
            section of our Privacy Policy. <br /> <br />
            Use of Your Personal Data ~~~~~~~~~~~~~~~~~~~~~~~~~ <br /> <br />
            The Company may use Personal Data for the following purposes:
            <br /> <br /> * To provide and maintain our Service , including to
            monitor the usage of our Service. <br /> <br />* To manage Your
            ...
            registered user. <br /> <br />* For the performance of a contract:
            ...
            information. <br /> <br />* To manage Your requests: To attend and
            manage Your requests to Us. <br /> <br />* For business transfers:
            ...
            users is among the assets transferred. <br /> <br />* For other
            ...
            <br /> <br />* With Service Providers: We may share Your personal
            information with Service Providers to monitor and analyze the use of
            our Service, to contact You. <br /> <br />* For business transfers:
            ...
            another company.
            <br /> <br /> * With Affiliates: We may share Your information with
            ...
            <br />* With business partners: We may share Your information with
            Our business partners to offer You certain products, services or
            promotions. <br /> <br />* With other users: when You share personal
            information or otherwise interact in the public areas with other
            users, such information may be viewed by all users and may be
            publicly distributed outside. <br /> <br />* With Your consent : We
            ...
            <br /> <br /> You have the right to delete or request that We assist
            in deleting the Personal Data that We have collected about You. Our
            Service may give You the ability to delete certain information about
            ...
            to do so.
            <br /> <br /> Disclosure of Your Personal Data
            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            <br /> <br /> Business Transactions *********************
            <br /> <br /> If the Company is involved in a merger, acquisition or
            ...
            <br /> <br /> Law enforcement *************** <br /> <br />
            Under certain circumstances, the Company may be required to disclose
            Your Personal Data if required to do so by law or in response to
            valid requests by public authorities (e.g. a court or a government
            agency).
            <br /> <br /> Other legal requirements ************************
            <br /> <br /> The Company may disclose Your Personal Data in the
            good faith belief that such action is necessary to: <br /> <br />*
            Comply with a legal obligation <br /> <br />* Protect and defend the
            rights or property of the Company <br /> <br />* Prevent or
            investigate possible wrongdoing in connection with the Service{" "}
            <br /> <br />* Protect the personal safety of Users of the Service
            or the public <br /> <br />* Protect against legal liability
            <br /> <br />
            Security of Your Personal Data ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            <br /> <br /> The security of Your Personal Data is important to Us,
            ...
            ------------------------------
            <br /> <br /> We may update Our Privacy Policy from time to time. We
