    ...
    <div className="w-full">
      ...
      >
        <div className="w-[90%] sm:w-[80%] md:w-[60%] m-auto mt-10 md:mt-16 mb-14">
          ...
          <p>Welcome to Writroai!</p>
          <br />
          <p>
            These terms and conditions outline the rules and regulations for the
            use of {"Writroai's"} Website, located at https://writroai.com{" "}
            <br />
            <br /> By accessing this website we assume you accept these terms
            and conditions. Do not continue to use Writroai if you do not agree
            ...
            of pk. Any use of the above terminology or other words in the
            singular, plural, capitalization and/or he/she or they, are taken as
            interchangeable and therefore as referring to the same.
          </p>
          <h2 className="text-2xl mt-6 mb-2 font-bold">Cookies</h2>
          <p>
            We employ the use of cookies. By accessing Writroai, you agreed to
            use cookies in agreement with the {"Writroai's"} Privacy Policy.{" "}
            <br />
          ...
          <h2 className="text-2xl mt-6 mb-2 font-bold">License</h2>
          <p>
            Unless otherwise stated, Writroai and/or its licensors own the
            intellectual property rights for all material on Writroai. All
            intellectual property rights are reserved. You may access this from
            Writroai for your own personal use subjected to restrictions set in
            these terms and conditions.
          </p>
          <br />
          <p>You must not:</p>
          <ul className=" list-disc mx-10 flex flex-col gap-2 py-4">
            <li>Republish material from Writroai</li>
            <li>Sell, rent or sub-license material from Writroai</li>
            <li>Reproduce, duplicate or copy material from Writroai</li>
            <li>Redistribute content from Writroai</li>
          </ul>
          <p>
            ...
            of the website. Writroai does not filter, edit, publish or review
            Comments prior to their presence on the website. Comments do not
            reflect the views and opinions of Writroai,its agents and/or
            ...
            applicable laws, Writroai shall not be liable for the Comments or
            ...
            Comments on this website. Writroai reserves the right to monitor all
          ...
          <p>
            You hereby grant Writroai a non-exclusive license to use, reproduce,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Writroai; and
            ...
            must inform us by sending an e-mail to Writroai. Please include your
          ...
          <p>
            No use of{" Writroai's"} logo or other artwork will be allowed for
            linking absent a trademark license agreement.
          </p>
          <h2 className="text-2xl mt-6 mb-2 font-bold">iFrames</h2>
          <p>
            Without prior approval and written permission, you may not create
            frames around our Webpages that alter in any way the visual
            presentation or appearance of our Website.
          </p>
          <h2 className="text-2xl mt-6 mb-2 font-bold">Content Liability</h2>
          <p>
          ...
          <h2 className="text-2xl mt-6 mb-2 font-bold">Disclaimer</h2>
          <p>
          ...
          <p>
            ...
            <br /> As long as the website and the information and services on
